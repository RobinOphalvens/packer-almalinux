...
# If the robinoph user is already setup, edit the existing bashrc file.
if [ -f /home/robinoph/.bashrc ]; then
  sed --in-place "s/#alias dir='dir --color=auto'/alias dir='dir --color=auto'/g" /home/robinoph/.bashrc
  sed --in-place "s/#alias vdir='vdir --color=auto'/alias vdir='vdir --color=auto'/g" /home/robinoph/.bashrc
  sed --in-place "s/#alias grep='grep --color=auto'/alias grep='grep --color=auto'/g" /home/robinoph/.bashrc
  sed --in-place "s/#alias fgrep='fgrep --color=auto'/alias fgrep='fgrep --color=auto'/g" /home/robinoph/.bashrc
  sed --in-place "s/#alias egrep='egrep --color=auto'/alias egrep='egrep --color=auto'/g" /home/robinoph/.bashrc
  sed --in-place "s/#export GCC_COLORS='error=01;31:warning=01;35:note=01;36:caret=01;32:locus=01:quote=01'/export GCC_COLORS='error=01;31:warning=01;35:note=01;36:caret=01;32:locus=01:quote=01'/g" /home/robinoph/.bashrc
fi
